...
describe("Task component non editable description", () => {
  ...
  it("should render", () => {
    expect(component.find("div.app-width.task").exists()).toBe(true);
  });
  ...
  it("state integrity", () =>
    ...
    ].forEach(({prop, value}) => expect(component.state(prop)).toBe(value)));
...
describe("Task component editable description", () => {
  ...
  component.find("div.description").simulate("doubleClick");
