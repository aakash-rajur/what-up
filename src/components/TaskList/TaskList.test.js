...
describe("TaskList component with List", () => {
  ...
  it("should render task-list", () => {
    expect(component.find("div.task-list").exists()).toBe(true);
    expect(component.children().length).toBe(props.tasks.length);
  });
  ...
  it("state integrity", () => {
    expect(component.state("tasks").length).toBe(tasks.length);
    expect(component.state("loading")).toBe(false);
  });
