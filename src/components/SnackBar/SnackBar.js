...
class SnackBar extends Component {
	...
	async componentDidUpdate(props) {
		if (this.props.message !== props.message) {
			...
			let fadeOut = wait(this.props.timeout + 500, setState, {animation: 'fade-out'});
	...
	render() {
		...
		return (
			<div className={`snack-bar ${animation}`}>
				...
				<img key='remove' src={CANCEL_ICON} alt="clear snack-bar"
				     className="icon clear" title='Set Cancel'
